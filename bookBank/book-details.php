  ...
  <div class="container-fuild">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-6 book">
        <img width="650" src="images\book.jpg" alt="">
      </div>

      <div class="col-sm-12 col-md-12 col-lg-6 book-deatils">
        <h1 class="book-name">Do Epic Shit</h1>
        <h6 class="author-name">Author : Person 1, Person 2</h6>
        <h6 class="donar-name">Donar : Person 5</h6>
        <h4 class="highlights">Highlights</h4>
        <ul>
          <li>Publisher : Bannari Amman Group India Pvt. Ltd.</li>
          <li>Language : English</li>
          <li>Edition : FIRST EDITION, 2016</li>
          <li>Pages : 280</li>
        </ul>
        ...
        <ul>
          <li>Bought On(approx.) : 01-01-2000</li>
          <li>Book Condition : Good</li>
          <li>Usage : 2 Years</li>
        </ul>
        <h5 class="no-of-books-avail">Number books available : 1</h5>
        <h5 class="donar-location">Donar Location : Erode</h5>

        <div class="deatils-page-btn">
          <a href="booking.php"><button class="get-now-btn">Get Now</button></a>
          <a href="books-for-dashboard.php"><button class="other-books-btn">View other Books</button></a>
        </div>
