...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h3 class="reply-msg"><i class="bi bi-hand-thumbs-up thumbs-up-icon"></i><br>You have logged out successfully.</h3>
    <h6 class="reply-msg">Return to <a href="index.php">Home</a></h6>
