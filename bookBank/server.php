...
if (isset($_POST['username'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (firstname,lastname,email,mobilenumber,aadharnumber,role,username,password)
  			  VALUES('$firstname','$lastname','$email','$mobilenumber','$aadharnumber','$role','$username','$password')";
